...
DEB_VERSION="1.0.0"
DEB_NAME="seeta-face-feature-server-${DEB_VERSION}-amd64.deb"
...
DEB_BIN_DIR=$DEB_WORK_DIR/opt/seeta_face_feature_server
...
-DDEFAULT_FEATURE_DATABASE_DIR=/data/seeta_face_database \
-DDEFAULT_FACE_MODELE_DIR=/opt/seeta_face_feature_server/sf3.0_models
...
echo "/opt/seeta_face_feature_server/lib" > $DEB_BIN_DIR/config/seeta-face-feature-server.conf
